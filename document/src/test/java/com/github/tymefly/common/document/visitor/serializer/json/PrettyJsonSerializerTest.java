...
/**
 * Unit test for {@link PrettyJsonSerializer}
 */
public class PrettyJsonSerializerTest {
    private enum Value {
        A, B, C
    }
    ...
    public void setUp() {
        source = Document.newInstance()
                ...
                .addNumbers(Key.ROOT_NUMBERS, 1, null, 3.4e-15, BigInteger.valueOf(Long.MAX_VALUE))
    ...
    /**
     * Unit test {@link PrettyJsonSerializer}
     */
    @Test
    public void test_PrettyJson() {
        String actual = source.accept(new PrettyJsonSerializer());
