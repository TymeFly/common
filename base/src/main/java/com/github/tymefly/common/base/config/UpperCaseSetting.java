 ...
 * that uses the uppercase {@link #name()} as the external key, which is typically used by environment variables
 * This interface is expected to be implemented by an {@code enum} type
 * @see ConfigSetting
 * @see EnvConfig
 */
public interface UpperCaseSetting extends ConfigSetting {
    /**
