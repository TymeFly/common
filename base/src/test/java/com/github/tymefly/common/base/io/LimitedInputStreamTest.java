...
public class LimitedInputStreamTest {
    ...
    public void setUp() {
        ...
        overflow = new LimitedInputStream(raw1, 3);
        underflow = new LimitedInputStream(raw2, 6);
    }
    ...
    public void test_read_byte_overflow() throws Exception {
        ...
        Assert.assertThrows(FailedIoException.class, () -> overflow.read());
    }
    ...
    public void test_read_array() throws Exception {
        ...
        Assert.assertThrows(FailedIoException.class, () -> overflow.read(buffer));
    }
    ...
    public void test_read_arrayWithOffset() throws Exception {
        ...
        Assert.assertArrayEquals("Unexpected Data", "Hel".getBytes(StandardCharsets.UTF_8), buffer);
        Assert.assertEquals("#3 available()", 0, overflow.available());
        Assert.assertThrows(FailedIoException.class, () -> overflow.read(buffer, 0, 1));
    }
    ...
    public void test_readNBytes() throws Exception {
        ...
        Assert.assertThrows(FailedIoException.class, () -> overflow.readNBytes(2));
    }
    ...
    public void test_readNBytes_withOffset() throws Exception {
        ...
        Assert.assertArrayEquals("Unexpected Data", "Hel".getBytes(StandardCharsets.UTF_8), buffer);
        Assert.assertThrows(FailedIoException.class, () -> overflow.readNBytes(buffer, 0, 1));
    }
    ...
    public void test_readAllBytes_overflow() {
        Assert.assertThrows(FailedIoException.class, () -> overflow.readAllBytes());
    }
    ...
    public void test_close() throws IOException {
        ...
        InputStream stream = new LimitedInputStream(backing);
