...
public class PreconditionsTest {
    ...
    /**
     * Unit test {@link Preconditions#checkSet}
     */
    @Test
    public void test_checkSet() {
        Preconditions.checkSet("Not Null", "myField");


        Exception actual = Assert.assertThrows(IllegalArgumentException.class,
                () -> Preconditions.checkSet(null, "myField"));

        Assert.assertEquals("Unexpected message", "myField has not been set", actual.getMessage());
    }
}